...
public class TestServiceForWeb {
	...
	public void setUp() throws Exception {
		when(applicationContext.getBean("numberOfSemester", Integer.class))
				.thenReturn(Integer.valueOf(8));

		when(subjectDao.getSubjectsBySpecializationId("KOTELEZO")).thenReturn(
				kotelezoSubjects);
		when(subjectDao.getSubjectsBySpecializationId("GEOTECHNIKAI"))
				.thenReturn(getotechnikaiSubjects);
	...
	/**
	 * Test method for
	 * {@link com.boky.SubjectParser.services.services.ServiceForWeb#getInitializedData(java.lang.String)}
	 * .
	 */
	@Test
	public void testGetInitializedDataWhenSpecializationIsGeotehcnikai() {
		...
		Specialization geotechnikaiSpecialization = new Specialization(
				"GEOTECHNIKAI", "Geotechnikai");

		when(specializationDao.getById("GEOTECHNIKAI")).thenReturn(
				geotechnikaiSpecialization);

		when(
				DTOTransformatorUtil
						.convertSubjectListToSubjectWithCodeAndNameAndSemesterDTOList(kotelezoSubjects))
				.thenReturn(
						createSubjectWithCodeAndNameAndSemesterDTOForKotelezo());
		when(
				DTOTransformatorUtil
						.convertSubjectListToSubjectWithCodeAndNameAndSemesterDTOList(getotechnikaiSubjects))
				.thenReturn(
						subjectWithCodeAndNameAndSemesterDTOsForGeotechnikai);
		when(
				DTOTransformatorUtil
						.convertSpecializatonListToSpecializationWithNameAndCodeDTOList(specializations))
				.thenReturn(specializationWithNameAndCodeDTOs);
		when(
				DTOTransformatorUtil
						.convertSpecializatonToSpecializationWithNameAndCodeDTO(geotechnikaiSpecialization))
				.thenReturn(
						new SpecializationWithNameAndCodeDTO("GEOTECHNIKAI",
								"Geotechnikai"));

		InitializationDataForWebDTO expectedInitializationDataForWebDTO = new InitializationDataForWebDTO();
		expectedInitializationDataForWebDTO
				.setSpecializations(specializationWithNameAndCodeDTOs);
		expectedInitializationDataForWebDTO.getSubjects().addAll(
				subjectWithCodeAndNameAndSemesterDTOsForGeotechnikai);
		expectedInitializationDataForWebDTO.getSubjects().addAll(
				subjectWithCodeAndNameAndSemesterDTOsForKotelezo);
		expectedInitializationDataForWebDTO.setNumberOfSemesters(Integer
				.valueOf(8));
		expectedInitializationDataForWebDTO
				.setActualSpecialization(new SpecializationWithNameAndCodeDTO(
						"GEOTECHNIKAI", "Geotechnikai"));

		// THEN

		assertEquals(expectedInitializationDataForWebDTO,
				serviceForWeb.getInitializedData("GEOTECHNIKAI"));
		...
		DTOTransformatorUtil
				.convertSubjectListToSubjectWithCodeAndNameAndSemesterDTOList(anyListOf(Subject.class));
	...
	public void testGetInitializedDataWhenSpecializationIsKotelezo() {
		...
		Specialization kotelezoSpecialization = new Specialization("KOTELEZO",
				"Kötelező");

		when(specializationDao.getById("KOTELEZO")).thenReturn(
				kotelezoSpecialization);
		...
		when(
				DTOTransformatorUtil
						.convertSpecializatonToSpecializationWithNameAndCodeDTO(kotelezoSpecialization))
				.thenReturn(
						new SpecializationWithNameAndCodeDTO("KOTELEZO",
								"Kötelező"));
		...
		assertEquals(expectedInitializationDataForWebDTO,
				serviceForWeb.getInitializedData("KOTELEZO"));
		verify(subjectDao).getSubjectsBySpecializationId("KOTELEZO");
	...
	/**
	 * Test method for
	 * {@link com.boky.SubjectParser.services.services.ServiceForWeb#getDependencyDepthAndDescription(java.lang.String, java.lang.String)}
	 * .
	 */
	@Test
	public void testGetDependencyDepthAndDescription() {
		...
		DependencyDepthAndDescriptionDTO actualDTO = serviceForWeb
				.getDependencyDepthAndDescription(subject.getId(),
						"GEOTECHNIKAI");
	...
	/**
	 * Test method for
	 * {@link com.boky.SubjectParser.services.services.ServiceForWeb#getAllSpecializationWithNameAndId()}
	 * .
	 */
	@Test
	public void testGetAllSpecializationWithNameAndId() {
		...
		when(
				DTOTransformatorUtil
						.convertSpecializatonListToSpecializationWithNameAndCodeDTOList(specializations))
				.thenReturn(specializationWithNameAndCodeDTOs);
		List<SpecializationWithNameAndCodeDTO> actualSpecializationWithNameAndCodeDTOs = serviceForWeb
				.getAllSpecializationWithNameAndId();

		PowerMockito.verifyStatic(times(1));
		DTOTransformatorUtil
				.convertSpecializatonListToSpecializationWithNameAndCodeDTOList(specializations);
		Assert.assertEquals(specializationWithNameAndCodeDTOs,
				actualSpecializationWithNameAndCodeDTOs);
	}

	/**
	 * Test method for
	 * {@link com.boky.SubjectParser.services.services.ServiceForWeb#getImageName()}
	 * .
	 */
	@Test
	...
	private Subject createSubjectWithDependecies() {
		...
		Specialization magasepitesi = new Specialization("MAGASEPITESI",
				"Magasépítési");
		Specialization geotechnikai = new Specialization("GEOTECHNIKAI",
				"Geotechnikai");
		...
		Subject subject = new Subject("SGYMMET203XXX",
				"Mechanika III. (Tartók statikája)", 3, 4, 5,
				SemesterClosing.FELEVKOZI, 5, 5, new HashSet<Dependency>(),
				onlyGeotechnikai, "It is a very long description");
		Subject subject2 = new Subject("2", "Two", 2, 2, 2,
				SemesterClosing.FELEVKOZI, 2, 2, new HashSet<Dependency>(),
				geotechnikaiMagasepitesi, "Description");
		Subject subject3 = new Subject("3", "Three", 2, 2, 2,
				SemesterClosing.FELEVKOZI, 2, 2, new HashSet<Dependency>(),
				onlyKotelezo, "Description");
		Subject subject4 = new Subject("4", "Four", 2, 2, 2,
				SemesterClosing.FELEVKOZI, 2, 2, new HashSet<Dependency>(),
				onlyKotelezo, "Description");
		Subject subject5 = new Subject("5", "Five", 2, 2, 2,
				SemesterClosing.FELEVKOZI, 2, 2, new HashSet<Dependency>(),
				onlyGeotechnikai, "Description");
		Subject subject6 = new Subject("6", "Six", 2, 2, 2,
				SemesterClosing.FELEVKOZI, 2, 2, new HashSet<Dependency>(),
				onlyGeotechnikai, "Description");
		Subject subject7 = new Subject("7", "Seven", 2, 2, 2,
				SemesterClosing.FELEVKOZI, 2, 2, new HashSet<Dependency>(),
				onlyGeotechnikai, "Description");
		Subject subject8 = new Subject("8", "Eight", 2, 2, 2,
				SemesterClosing.FELEVKOZI, 2, 2, new HashSet<Dependency>(),
				onlyGeotechnikai, "Description");
		Subject subject9 = new Subject("9", "Nine", 2, 2, 2,
				SemesterClosing.FELEVKOZI, 2, 2, new HashSet<Dependency>(),
				onlyKotelezo, "Description");
		Subject subject10 = new Subject("10", "Ten", 2, 2, 2,
				SemesterClosing.FELEVKOZI, 2, 2, new HashSet<Dependency>(),
				onlyGeotechnikai, "Description");
		Subject subject11 = new Subject("11", "Eleven", 2, 2, 2,
				SemesterClosing.FELEVKOZI, 2, 2, new HashSet<Dependency>(),
				geotechnikaiMagasepitesi, "Description");
		Subject subject12 = new Subject("12", "Twelve", 2, 2, 2,
				SemesterClosing.FELEVKOZI, 2, 2, new HashSet<Dependency>(),
				onlyGeotechnikai, "Description");
		Subject subject13 = new Subject("13", "Thirteen", 2, 2, 2,
				SemesterClosing.FELEVKOZI, 2, 2, new HashSet<Dependency>(),
				onlyGeotechnikai, "Description");
		Subject subject14 = new Subject("14", "Fourteen", 2, 2, 2,
				SemesterClosing.FELEVKOZI, 2, 2, new HashSet<Dependency>(),
				onlyMagasepitesi, "Description");
		Subject subject15 = new Subject("15", "Fifteen", 2, 2, 2,
				SemesterClosing.FELEVKOZI, 2, 2, new HashSet<Dependency>(),
				onlyGeotechnikai, "Description");
		Subject subject16 = new Subject("16", "Sixteen", 2, 2, 2,
				SemesterClosing.FELEVKOZI, 2, 2, new HashSet<Dependency>(),
				onlyGeotechnikai, "Description");
		Subject subject17 = new Subject("17", "Seventeen", 2, 2, 2,
				SemesterClosing.FELEVKOZI, 2, 2, new HashSet<Dependency>(),
				onlyGeotechnikai, "Description");

		Dependency dependency = new Dependency(subject8, geotechnikai, false,
				subject9);
	...
	private static List<Specialization> createSpecializationList() {
		...
		specializations.add(new Specialization("TUZVEDELMI",
				"Tűz- és katasztrófavédelmi"));
		specializations.add(new Specialization("VALASZTHATO",
	...
	private static List<SpecializationWithNameAndCodeDTO> createSpeciailzationWithNameAndCodeDTOs() {
		...
		specializationWithNameAndCodeDTOs
				.add(new SpecializationWithNameAndCodeDTO("KOTELEZO",
						"Kötelező"));
		specializationWithNameAndCodeDTOs
				.add(new SpecializationWithNameAndCodeDTO("GEOTECHNIKAI",
						"Geotechnikai"));
		specializationWithNameAndCodeDTOs
				.add(new SpecializationWithNameAndCodeDTO("TELEPULESI",
						"Települési"));
		specializationWithNameAndCodeDTOs
				.add(new SpecializationWithNameAndCodeDTO("MAGASEPITESI",
						"Magasépítési"));
		specializationWithNameAndCodeDTOs
				.add(new SpecializationWithNameAndCodeDTO("TUZVEDELMI",
						"Tűz- és katasztrófavédelmi"));
		specializationWithNameAndCodeDTOs
				.add(new SpecializationWithNameAndCodeDTO("VALASZTHATO",
						"Szabadon választható"));
	...
	private static List<SubjectWithCodeAndNameAndSemesterDTO> createSubjectWithCodeAndNameAndSemesterDTOForKotelezo() {
		...
		codeAndNameAndSemesterDTOs
				.add(new SubjectWithCodeAndNameAndSemesterDTO("SGYMASZ2021XA",
						"Ábrázoló geometria", 1));
		codeAndNameAndSemesterDTOs
				.add(new SubjectWithCodeAndNameAndSemesterDTO("SGYMASZ206XXX",
						"Építészeti rajz", 2));
		codeAndNameAndSemesterDTOs
				.add(new SubjectWithCodeAndNameAndSemesterDTO("SGYMMAT201XXX",
						"Matematika I.", 3));
		codeAndNameAndSemesterDTOs
				.add(new SubjectWithCodeAndNameAndSemesterDTO("SGYMMAT202XXX",
						"Matematika II.", 4));
		codeAndNameAndSemesterDTOs
				.add(new SubjectWithCodeAndNameAndSemesterDTO("SGYMMET201XXX",
						"Mechanika I. (Statika)", 3));
		codeAndNameAndSemesterDTOs
				.add(new SubjectWithCodeAndNameAndSemesterDTO("SGYMMET202XXX",
						"Mechanika II. (Szilárdságtan)", 2));
		codeAndNameAndSemesterDTOs
				.add(new SubjectWithCodeAndNameAndSemesterDTO("SGYMMET203XXX",
						"Mechanika III. (Tartók statikája)", 1));
		codeAndNameAndSemesterDTOs
				.add(new SubjectWithCodeAndNameAndSemesterDTO("SGYMMET2011XA",
						"Mérnökfizika és a méretezés alapjai", 6));
	...
	private static List<SubjectWithCodeAndNameAndSemesterDTO> createSubjectWithCodeAndNameAndSemesterDTOForGeotechnikai() {
		List<SubjectWithCodeAndNameAndSemesterDTO> codeAndNameAndSemesterDTOs = new ArrayList<>();
		codeAndNameAndSemesterDTOs
				.add(new SubjectWithCodeAndNameAndSemesterDTO("SGYMTUB2317XA",
						"A katasztrófavédelem alapjai", 5));
		codeAndNameAndSemesterDTOs
				.add(new SubjectWithCodeAndNameAndSemesterDTO("SGYMKOM241XXX",
						"Alapozás kedvezőtlen altalajon", 4));
		codeAndNameAndSemesterDTOs
				.add(new SubjectWithCodeAndNameAndSemesterDTO("SGYMKOM2356XA",
						"Az épületgépészet alapjai", 3));
		codeAndNameAndSemesterDTOs
				.add(new SubjectWithCodeAndNameAndSemesterDTO("SGYMKOM2346XA",
						"Geotechnika IV. (Alapozás II.)", 3));
		codeAndNameAndSemesterDTOs
				.add(new SubjectWithCodeAndNameAndSemesterDTO("SGYMKOM2376XA",
						"Geotechnika mérőgyakorlat", 5));
		codeAndNameAndSemesterDTOs
				.add(new SubjectWithCodeAndNameAndSemesterDTO("SGYMKOM235XXX",
						"Geotechnika V.", 1));
		codeAndNameAndSemesterDTOs
				.add(new SubjectWithCodeAndNameAndSemesterDTO("SGYMKOM2408XA",
						"Hulladékgazdálkodás", 7));
		return codeAndNameAndSemesterDTOs;
	}

	private static List<Subject> createListForKotelzoSpec() {
		List<Subject> subjects = new ArrayList<>();
		subjects.add(new Subject("SGYMASZ2021XA", "Ábrázoló geometria", 1, 2,
				2, SemesterClosing.FELEVKOZI, 5, 1, new HashSet<Dependency>(),
				new HashSet<Specialization>(), "Desc"));
		subjects.add(new Subject("SGYMASZ206XXX", "Építészeti rajz", 1, 2, 2,
				SemesterClosing.FELEVKOZI, 5, 2, new HashSet<Dependency>(),
				new HashSet<Specialization>(), "Desc"));
		subjects.add(new Subject("SGYMMAT201XXX", "Matematika I.", 1, 2, 2,
				SemesterClosing.FELEVKOZI, 5, 3, new HashSet<Dependency>(),
				new HashSet<Specialization>(), "Desc"));
		subjects.add(new Subject("SGYMMAT202XXX", "Matematika II.", 1, 2, 2,
				SemesterClosing.FELEVKOZI, 5, 4, new HashSet<Dependency>(),
				new HashSet<Specialization>(), "Desc"));
		subjects.add(new Subject("SGYMMET201XXX", "Mechanika I. (Statika)", 1,
				2, 2, SemesterClosing.FELEVKOZI, 5, 3,
				new HashSet<Dependency>(), new HashSet<Specialization>(),
				"Desc"));
		subjects.add(new Subject("SGYMMET202XXX",
				"Mechanika II. (Szilárdságtan)", 1, 2, 2,
				SemesterClosing.FELEVKOZI, 5, 2, new HashSet<Dependency>(),
				new HashSet<Specialization>(), "Desc"));
		subjects.add(new Subject("SGYMMET203XXX",
				"Mechanika III. (Tartók statikája)", 1, 2, 2,
				SemesterClosing.FELEVKOZI, 5, 1, new HashSet<Dependency>(),
				new HashSet<Specialization>(), "Desc"));
		subjects.add(new Subject("SGYMMET2011XA",
				"Mérnökfizika és a méretezés alapjai", 1, 2, 2,
				SemesterClosing.FELEVKOZI, 5, 6, new HashSet<Dependency>(),
				new HashSet<Specialization>(), "Desc"));
	...
	private static List<Subject> createListForGeotechnikaiSpec() {
		List<Subject> subjects = new ArrayList<>();
		subjects.add(new Subject("SGYMTUB2317XA",
				"A katasztrófavédelem alapjai", 0, 1, 1,
				SemesterClosing.FELEVKOZI, 4, 5, new HashSet<Dependency>(),
				new HashSet<Specialization>(), "Desc"));
		subjects.add(new Subject("SGYMKOM241XXX",
				"Alapozás kedvezőtlen altalajon", 1, 1, 1,
				SemesterClosing.FELEVKOZI, 3, 4, new HashSet<Dependency>(),
				new HashSet<Specialization>(), "Desc"));
		subjects.add(new Subject("SGYMKOM2356XA", "Az épületgépészet alapjai",
				2, 1, 1, SemesterClosing.FELEVKOZI, 6, 3,
				new HashSet<Dependency>(), new HashSet<Specialization>(),
				"Desc"));
		subjects.add(new Subject("SGYMKOM2346XA",
				"Geotechnika IV. (Alapozás II.)", 3, 1, 1,
				SemesterClosing.FELEVKOZI, 4, 3, new HashSet<Dependency>(),
				new HashSet<Specialization>(), "Desc"));
		subjects.add(new Subject("SGYMKOM2376XA", "Geotechnika mérőgyakorlat",
				4, 1, 1, SemesterClosing.FELEVKOZI, 7, 5,
				new HashSet<Dependency>(), new HashSet<Specialization>(),
				"Desc"));
		subjects.add(new Subject("SGYMKOM235XXX", "Geotechnika V.", 5, 1, 1,
				SemesterClosing.FELEVKOZI, 3, 1, new HashSet<Dependency>(),
				new HashSet<Specialization>(), "Desc"));
		subjects.add(new Subject("SGYMKOM2408XA", "Hulladékgazdálkodás", 6, 1,
				1, SemesterClosing.FELEVKOZI, 3, 7, new HashSet<Dependency>(),
				new HashSet<Specialization>(), "Desc"));
		return subjects;
	}
