...
public class TestDependencyDaoJPA {
    ...
    public void testGetDependencyById() {
        ...
        Dependency expectedDependency = new Dependency(1L, subject1, new Specialization("KOTELEZO", "Kötelező"), false, subject2);
    ...
    public void testGetDependeniesBySubjectId() {
        ...
        expectedDependeniesBySubjectId.add(new Dependency(4L, subject3, new Specialization("KOTELEZO", "Kötelező"), false, subject1));
        expectedDependeniesBySubjectId.add(new Dependency(5L, subject3, new Specialization("KOTELEZO", "Kötelező"), true, subject2));
        expectedDependeniesBySubjectId.add(new Dependency(6L, subject3, new Specialization("MAGASEPITESI", "Magasépítési"), true, subject2));
    ...
    public void testGetDependenciesBySubjectIdAndSpecialization() {
        ...
        List<Dependency> expectedDependeniesBySubjectId = new ArrayList<Dependency>();
        expectedDependeniesBySubjectId.add(new Dependency(4L, subject2, new Specialization("KOTELEZO", "Kötelező"), false, subject1));
        expectedDependeniesBySubjectId.add(new Dependency(5L, subject2, new Specialization("KOTELEZO", "Kötelező"), true, subject3));
    ...
    /**
     * Test method for {@link com.boky.SubjectParser.daolayer.implementations.DependencyDaoJPA2#getDependenciesByDependencySubjectIdAndSpecializationId(java.lang.String, java.lang.Long)}.
     */
    @Test
    public void testGetDependeciesByDependencySubjectIdAndSpecializationId() {
        ...
        List<Dependency> expectedDependeniesBySubjectId = new ArrayList<Dependency>();
        expectedDependeniesBySubjectId.add(new Dependency(3L, subject1, new Specialization("KOTELEZO", "Kötelező"), false, subject3));
        expectedDependeniesBySubjectId.add(new Dependency(4L, subject2, new Specialization("KOTELEZO", "Kötelező"), false, subject3));
