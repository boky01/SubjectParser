...
public class TestDependencyDaoJPA {
	...
	/**
	 * Test method for
	 * {@link com.boky.SubjectParser.daolayer.implementations.DependencyDaoJPA2#getDependencyById(java.lang.Long)}
	 * .
	 */
	@Test
	public void testGetDependencyById() {
		Subject subject1 = new Subject("SGYMMET202XXX", null, null, null, null,
				null, null, null, null, null, null);
		Subject subject2 = new Subject("SGYMMET201XXX", null, null, null, null,
				null, null, null, null, null, null);

		Dependency expectedDependency = new Dependency(subject1,
				new Specialization("KOTELEZO", "Kötelező"), false, subject2)
				.setId(1L);
	...
	public void testGetAllDependency() throws DataSetException {
		...
		Assert.assertEquals(allDependency.size(), dbUnitInitializer
				.createActualDataSet().getTable("dependency").getRowCount());
	}

	/**
	 * Test method for
	 * {@link com.boky.SubjectParser.daolayer.implementations.DependencyDaoJPA2#getDependeniesBySubjectId(java.lang.String)}
	 * .
	 */
	@Test
	public void testGetDependeniesBySubjectId() {
		...
		expectedDependeniesBySubjectId.add(new Dependency(subject3,
				new Specialization("KOTELEZO", "Kötelező"), false, subject1)
				.setId(4L));
		expectedDependeniesBySubjectId.add(new Dependency(subject3,
				new Specialization("KOTELEZO", "Kötelező"), true, subject2)
				.setId(5L));
		expectedDependeniesBySubjectId.add(new Dependency(subject3,
				new Specialization("MAGASEPITESI", "Magasépítési"), true,
				subject2).setId(6L));

		List<Dependency> dependeniesBySubjectId = dependencyDaoJPA
				.getDependenciesBySubjectId("SGYMMET206XXX");
		Assert.assertEquals(expectedDependeniesBySubjectId,
				dependeniesBySubjectId);
	}

	/**
	 * Test method for
	 * {@link com.boky.SubjectParser.daolayer.implementations.DependencyDaoJPA2#getDependenciesBySubjectIdAndSpecializationId(java.lang.String, java.lang.Long)}
	 * .
	 */
	@Test
	public void testGetDependenciesBySubjectIdAndSpecialization() {
		Subject subject1 = new Subject("SGYMMET203XXX", null, null, null, null,
				null, null, null, null, null, null);
		Subject subject2 = new Subject("SGYMMET206XXX", null, null, null, null,
				null, null, null, null, null, null);
		Subject subject3 = new Subject("SGYMTUB2317XA", null, null, null, null,
				null, null, null, null, null, null);

		List<Dependency> expectedDependeniesBySubjectId = new ArrayList<Dependency>();
		expectedDependeniesBySubjectId.add(new Dependency(subject2,
				new Specialization("KOTELEZO", "Kötelező"), false, subject1)
				.setId(4L));
		expectedDependeniesBySubjectId.add(new Dependency(subject2,
				new Specialization("KOTELEZO", "Kötelező"), true, subject3)
				.setId(5L));
		List<Dependency> actualDependeniesBySubjectId = dependencyDaoJPA
				.getDependenciesBySubjectIdAndSpecializationId("SGYMMET206XXX",
						"KOTELEZO");

		Assert.assertEquals(expectedDependeniesBySubjectId,
				actualDependeniesBySubjectId);
	}
	...
	public void testGetDependeciesByDependencySubjectIdAndSpecializationId() {
		Subject subject1 = new Subject("SGYMMET205XXX", null, null, null, null,
				null, null, null, null, null, null);
		Subject subject2 = new Subject("SGYMMET206XXX", null, null, null, null,
				null, null, null, null, null, null);
		Subject subject3 = new Subject("SGYMMET203XXX", null, null, null, null,
				null, null, null, null, null, null);

		List<Dependency> expectedDependeniesBySubjectId = new ArrayList<Dependency>();
		expectedDependeniesBySubjectId.add(new Dependency(subject1,
				new Specialization("KOTELEZO", "Kötelező"), false, subject3)
				.setId(3L));
		expectedDependeniesBySubjectId.add(new Dependency(subject2,
				new Specialization("KOTELEZO", "Kötelező"), false, subject3)
				.setId(4L));
		List<Dependency> dependeniesBySubjectId = dependencyDaoJPA
				.getDependenciesByDependencySubjectIdAndSpecializationId(
						"SGYMMET203XXX", "KOTELEZO");
	...
	/**
	 * Test method for
	 * {@link com.boky.SubjectParser.daolayer.implementations.DependencyDaoJPA2#deleteDependencyById(java.lang.Long)}
	 * .
	 * 
	...
	public void testDeleteDependencyById() throws DatabaseUnitException {
		...
		IDataSet expectedDatabaseDataSet = dbUnitInitializer
				.createExpectedDataSet("expectedDataSetWhenDeleteADependency.xml");
	...
	/**
	 * Test method for
	 * {@link com.boky.SubjectParser.daolayer.implementations.DependencyDaoJPA2#saveOrUpdateDependency(com.boky.SubjectParser.daolayer.entities.Dependency)}
	 * .
	 */
	@Test
	public void testSaveOrUpdateDependencyWhenSave()
			throws DatabaseUnitException {
		Dependency dependency = new Dependency(
				subjectDaoJPA.getById("SGYMTUB2317XA"),
				specializationDaoJPA.getById("GEOTECHNIKAI"), false,
		...
		IDataSet expectedDatabaseDataSet = dbUnitInitializer
				.createExpectedDataSet("expectedDataSetWhenInsertADependency.xml");
		Assertion.assertEquals(expectedDatabaseDataSet, actualDatabaseDataSet);
	}
	 ...
	 */
	@Test
	public void testSaveOrUpdateDependencyWhenUpdate()
			throws DatabaseUnitException {
		...
		IDataSet actualDatabaseDataSet = dbUnitInitializer
				.createActualDataSet();
		IDataSet expectedDatabaseDataSet = dbUnitInitializer
				.createExpectedDataSet("expectedDataSetWhenUpdateADependency.xml");
		Assertion.assertEquals(expectedDatabaseDataSet, actualDatabaseDataSet);
	}
}
