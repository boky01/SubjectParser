...
public class TestSubjectDaoJPA {
    ...
    private List<Subject> createExceptedSubjectListForGetSubjectsBySpecializationSomethingTest() {
        ...
        dependencies.add(new Dependency(4L, subject3, new Specialization("KOTELEZO", "Kötelező"), false, subject1));
        dependencies.add(new Dependency(5L, subject3, new Specialization("KOTELEZO", "Kötelező"), true, subject2));
        dependencies.add(new Dependency(6L, subject3, new Specialization("MAGASEPITESI", "Magasépítési"), true, subject2));
     ...
     */
    @Test
    public void testSaveOrUpdateSubjectWhenUpdate() throws DatabaseUnitException {
    ...
    public void testGetForwardDependencies() {
        ...
        Subject subject = new Subject("SGYMMET202XXX", null, null, null, null, null, null, null, null, null, null);
        Subject dependencySubject = new Subject("SGYMMET201XXX", null, null, null, null, null, null, null, null, null, null);
        expectedForwardDependecies.add(new Dependency(1L, subject, new Specialization("KOTELEZO", "Kötelező"), false, dependencySubject));
        Set<Dependency> actualForwardDependencies = subjectDaoJPA.getById("SGYMMET201XXX").getForwardDependencies();
